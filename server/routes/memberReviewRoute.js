...
memberReviewRoute.put(
  '/:memberReviewId',
  authenticate,
  memberReviewCrl.updateMemberReview
);
memberReviewRoute.get('/:memberReviewId', memberReviewCrl.viewMemberReview);
memberReviewRoute.get(
  '/getActivityReviewByProductId/:productId',
  memberReviewCrl.getActivityReviewByProductId
);
memberReviewRoute.delete(
  '/:memberReviewId',
  authenticate,
  memberReviewCrl.deleteMemberReview
);
