...
router.get(
  ...
  authenticate,
  bankCtrl.fetchAccount
);
router.put(
  '/bank-accounts/:bankAccountId',
  authenticate,
  bankCtrl.updateRecipient
);
router.delete(
  '/bank-accounts/:bankAccountId',
  authenticate,
  bankCtrl.deleteRecipient
);
...
router.get(
  ...
  authenticate,
  checkIfAdmin,
  walletCtrl.fetchAllWalletHistories
);
router.get(
  '/wallet-history/:userId',
  authenticate,
  checkIfAdmin,
  walletCtrl.fetchUserWalletHistory
);
