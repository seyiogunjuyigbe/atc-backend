...
const {createContent,fetchContent,deleteContent,fetchAllContent,fetchAllGifs,fetchAllImages,fetchAllVideos,fetchContentForThisType} = require("../controllers/contentController");
